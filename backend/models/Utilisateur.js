  ...
  "Utilisateur",
  {
    ...
    nom: {
      ...
      validate: {
        ...
        is: {
          args: /^[a-zA-ZÀ-ÿ\s'-]*$/,
          msg: "Le nom ne doit contenir que des lettres, espaces et caractères spéciaux (é, è, ê, etc.)"
        }
      }
    },
    prenom: {
      ...
      validate: {
        ...
        is: {
          args: /^[a-zA-ZÀ-ÿ\s'-]*$/,
          msg: "Le prénom ne doit contenir que des lettres, espaces et caractères spéciaux (é, è, ê, etc.)"
        }
      }
    },
    email: {
    ...
    posteTravail: {
      ...
      validate: {
        is: {
          args: /^[a-zA-ZÀ-ÿ\s'-]*$/,
          msg: 'Le poste de travail ne doit contenir que des lettres, espaces et caractères spéciaux (é, è, ê, etc.)',
        },
        len: {
          args: [0, 100],
          msg: "Le poste de travail ne doit pas dépasser 100 caractères"
    ...
    brancheFonction: {
      ...
      validate: {
        is: {
          args: /^[a-zA-ZÀ-ÿ\s'-]*$/,
          msg: 'La branche fonctionnelle ne doit contenir que des lettres, espaces et caractères spéciaux (é, è, ê, etc.)',
        },
        len: {
          args: [0, 100],
          msg: "La branche fonctionnelle ne doit pas dépasser 100 caractères"
