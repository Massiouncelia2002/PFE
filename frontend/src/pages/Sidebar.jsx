...
//       title: null,
//       items: [
//         { name: 'Dashboard', icon: HomeIcon, to: '/admin-fonctionnel' },
//       ],
//     },
//     {
//       title: 'Gestion',
...
//           icon: UserIcon,
//           children: [
//             { name: 'Afficher', to: '/utilisateurs' },
//             { name: 'Ajouter', to: '/ajouter-utilisateur' },
//           ],
//         },
//         {
//           name: 'Dépôts',
//           icon: HomeIcon,
//           children: [
//             { name: 'Afficher', to: '/depots' },
//             { name: 'Ajouter', to: '/ajouter-depot' },
//           ],
//         },
//         {
//           name: 'Articles',
//           icon: ChartBarIcon,
//           children: [
//             { name: 'Liste', to: '/liste-articles' },
//             { name: 'Ajouter', to: '/articles' },
//           ],
//         },
//         {
//           name: 'Famille',
//           icon: ChartBarIcon,
//           to: '/famillesSousFamillespage',
//         },
//         {
//           name: 'Vehicule',
//           icon: ChartBarIcon,
//           children: [
//             { name: 'Liste', to: '/vehicules' },
//             { name: 'Ajouter', to: '/ajouter-vehicule' },
//           ],
//         },
//         {
//           name: 'Client',
//           icon: UserIcon,
//           children: [
//             { name: 'Liste', to: '/clients' },
//             { name: 'Ajouter', to: '/ajouter-client' },
//           ],
//         },
//         {
//           name: 'Affectation',
//           icon: UserIcon,
//           children: [
//             { name: 'Articles to depots', to: '/article-depot' },
//             { name: 'Utilisateurs to depots', to: '/affecter-depot' },
//           ],
//         },
...
const Sidebar = ({ isOpen, closeSidebar }) => {
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          icon: UserIcon,
          children: [
            { name: 'Articles to depots', to: '/AffecterDepotArticle' },
            { name: 'Utilisateurs to depots', to: '/affecter-depot' },
          ],
        },
      ],
  ...
  return (
    <>
      {/* Overlay noir en arrière-plan sur mobile */}
      <div
