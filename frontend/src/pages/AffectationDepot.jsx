...
//                         {/* Liste des utilisateurs avec leurs dépôts */}
//                         <div className="bg-white rounded-2xl shadow-xl p-8 border border-slate-200">
    ...
    const handleAddDepot = () => {
        if (selectedDepot) {
            if (utilisateurData?.role === "Admin Dépôt") {
                // Pour les admins dépôt, remplacer le dépôt existant
                setDepotsAffectes([selectedDepot]);
            } else {
                // Pour les autres rôles, ajouter normalement
                                                ...
                                                return (
                                                    <div
                                                        ...
                                                        onClick={() => {
                                                            if (!estInterdit && !estDejaAffecte) {
                                                                if (utilisateurData?.role === "Admin Dépôt") {
                                                                    // Pour admin dépôt, remplacer directement la sélection
