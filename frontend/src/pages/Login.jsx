...
//               ⚠️ Tentatives de connexion échouées : <strong>{tentatives}</strong>
//             </div>
//           )}
...
//     e.preventDefault();
//     if (isBlocked) {
//       toast.error("Trop de tentatives échouées. Réessayez plus tard.", { theme: darkMode ? "dark" : "light" });
//       return;
//     }
...
//               🔒 Vous avez dépassé le nombre de tentatives. Veuillez réessayer plus tard.
//             </div>
//           )}
