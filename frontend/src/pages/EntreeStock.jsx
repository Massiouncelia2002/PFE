...
//     if (!file || !dateEntree) {
//         alert("Veuillez sélectionner un fichier Excel et renseigner la date d'entrée.");
//         return;
//     }

//     const formData = new FormData();
//     formData.append("fichierExcel", file);
//     formData.append("dateEntree", dateEntree); // 👈 Important

//     try {
//         const res = await axios.post("http://localhost:5000/entree/importer-excel", formData);
