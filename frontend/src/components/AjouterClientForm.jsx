...
// // // Composant InputField optimisé (inchangé)
// // const InputField = React.memo(({ icon: Icon, error, label, className = "", ...props }) => {
// //   // ... (votre implémentation existante)
// // });

// // // Composant SelectField optimisé (inchangé)
// // const SelectField = React.memo(({ icon: Icon, error, label, children, ...props }) => {
// //   // ... (votre implémentation existante)
// // });
...
// //   const [isSubmitting, setIsSubmitting] = useState(false);
// //   const [showSuccess, setShowSuccess] = useState(false);
// //   const [importErrors, setImportErrors] = useState([]); // Nouvel état pour les erreurs d'import

// //   // Récupération des dépôts (inchangé)
// //   useEffect(() => {
// //     // ... (votre implémentation existante)
// //   }, []);

// //   // Détection automatique du dépôt (inchangé)
// //   useEffect(() => {
// //     // ... (votre implémentation existante)
// //   }, [formData.adress, depots]);

// //   // Fonctions extractWilayaFromAddress et getDepotByWilaya (inchangées)
// //   const extractWilayaFromAddress = useCallback((address) => {
// //     // ... (votre implémentation existante)
// //   }, [depots]);
...
// //   // Validation mémoïsée (adaptée pour correspondre au backend)
// //   const validateForm = useCallback(() => {
// //     const newErrors = {};
...
// //     if (!formData.adress.trim()) {
// //       newErrors.adress = "L'adresse est requise";
// //     } else if (!/[a-zA-Z]/.test(formData.adress) || !/\d/.test(formData.adress)) {
// //       newErrors.adress = "L'adresse doit contenir des lettres et des numéros";
// //     }

// //     if (!formData.tel.trim()) {
// //       newErrors.tel = "Le téléphone est requis";
// //     } else if (!/^\d+$/.test(formData.tel)) {
// //       newErrors.tel = "Le téléphone ne doit contenir que des chiffres";
// //     }
...
// //   // Gestion des changements optimisée (inchangée)
// //   const handleChange = useCallback((e) => {
// //     // ... (votre implémentation existante)
// //   }, [erreurs]);

// //   // Soumission du formulaire (adaptée pour le backend)
// //   const handleSubmit = useCallback(async (e) => {
// //     e.preventDefault();
// //     setErrorMessage("");
// //     setMessage("");
...
// //           if (data.errors) {
// //             // Convertir les erreurs du backend en format compatible avec notre état
// //             const backendErrors = {};
// //             data.errors.forEach(err => {
// //               const field = err.path || err.field || 'global';
...
// //   // Gestion du fichier Excel (adaptée pour le backend)
...
// //         const response = await fetch("/client/import", {
// //           method: "POST",
// //           headers: {
// //             "Content-Type": "application/json",
// //           },
...
// //         setMessage(result.message || `${jsonData.length} clients importés avec succès`);
// //       } catch (error) {
// //         setErrorMessage(error.message);
// //       }
// //     };
...
// //   // Composant pour afficher les erreurs d'import
...
// //                       Données: {JSON.stringify(error.details)}
// //                     </p>
// //                   )}
// //                 </div>
// //               </div>
...
// //           {/* Main Form Card (inchangé) */}
// //           <div className="bg-white rounded-2xl shadow-xl p-8 mb-6 border border-gray-100">
// //             {/* ... (votre formulaire existant) */}
// //           </div>

// //           {/* Action Cards (inchangé) */}
// //           <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
// //             {/* ... (vos cartes d'action existantes) */}
// //           </div>
...
//       if (XLSX.utils.sheet_to_json(worksheet, { defval: "" }).length === 0) {
...
//         if (result.errors) {
//           setImportErrors(result.errors);
//           setErrorMessage(`Erreurs lors de l'importation (${result.errors.length} erreurs)`);
//         }
//         throw new Error(result.message || "Erreur lors de l'importation");
//       }
...
//   formData.append("file", file); // le champ doit s'appeler "file" pour multer
...
//         setErrorMessage(`Erreurs lors de l'importation (${result.errors.length} erreurs)`);
//       } else {
//         setErrorMessage(result.message || "Erreur lors de l'importation");
//       }
//       return;
//     }
...
//       // ✅ Envoi du fichier avec FormData (pour multer côté serveur)
//       const formData = new FormData();
...
//       setMessage(result.message || "Clients importés avec succès");
//     } catch (error) {
//       setErrorMessage(error.message || "Une erreur est survenue lors de l'importation");
//     }
//   };
